...
strength_overall = strength_overall['Opponent', 'Team','Week','Week_Expected','Avg_Wins','Difference','% Difference']
#strength_overall.rename(columns={'Opponent': 'Team','Team':'Opponent'},inplace=True)
