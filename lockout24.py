...
with tab4:
   ...
   strength_bar = px.bar(strength_cats, x="Team", y="Count",color="Opponent...",color_discrete_sequence=["orange", "red", "green", "blue", "purple"],title="Opponent Performance By Week")
   st.plotly_chart(strength_bar, theme=None,use_container_width=True)
