...
with tab1:
   ...
   cumulative_roto = px.line(all_weeks, x="Week", y=line, markers=True, color='Team', symbol='Team',color_discrete_sequence=px.colors.qualitative.Dark24,title="Cumulative Roto Standings").update_xaxes(type='category')
