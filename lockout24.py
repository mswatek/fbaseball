...
conditions = [strength_cats['% Difference'] >.5,strength_cats['% Difference'] >.2,strength_cats['% Difference'] <-.5,strength_cats['% Difference']<-.2,strength_cats['% Difference']>0,strength_cats['% Difference']<0]
